...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with Temple Beth Shalom. Contact us about membership, programs, services, or to schedule a visit to our synagogue.',
  keywords: ['Contact Synagogue', 'Temple Membership', 'Jewish Community', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about our congregation? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">office@templebethshalom.org</p>
                    <p className="text-gray-600">support@templebethshalom.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 678-9031</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Office: Monday - Friday 9:00 AM - 4:00 PM<br />
                      Shabbat Services: Friday 6:30 PM, Saturday 9:30 AM
                    </p>
                  </div>
                </div>
              </div>
